...
export const App = () => {
    ...
    const [projectKey, setProjectKey] = useState("fa_e153bc3419757ed5384c4eb53ba2d24d94f58b0d7089c08f14e63250c8030be1");
    const [endpoint, setEndpoint] = useState("http://localhost:3000/api/events");
    ...
    return (_jsxs("div", { style: { padding: "2rem", maxWidth: "800px", margin: "0 auto" }, children: [_jsx("h1", { children: "Fast Analytics SDK Test App" }), _jsxs("div", { style: {
                    ...
                    borderRadius: "8px",
                }, children: [_jsx("h2", { children: "\u0418\u043D\u0438\u0446\u0438\u0430\u043B\u0438\u0437\u0430\u0446\u0438\u044F SDK" }), _jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "1rem" }, children: [_jsxs("div", { children: [_jsx("label", { style: { display: "block", marginBottom: "0.5rem" }, children: "Project Key:" }), _jsx("input", { type: "text", value: projectKey, onChange: (e) => setProjectKey(e.target.value), placeholder: "\u0412\u0432\u0435\u0434\u0438\u0442\u0435 project key", style: { width: "100%", padding: "0.5rem" }, disabled: isInitialized })] }), _jsxs("div", { children: [_jsx("label", { style: { display: "block", marginBottom: "0.5rem" }, children: "Endpoint:" }), _jsx("input", { type: "text", value: endpoint, onChange: (e) => setEndpoint(e.target.value), placeholder: "http://localhost:3000/api/events", style: { width: "100%", padding: "0.5rem" }, disabled: isInitialized })] }), _jsxs("div", { children: [_jsx("label", { style: { display: "block", marginBottom: "0.5rem" }, children: "User ID (\u043E\u043F\u0446\u0438\u043E\u043D\u0430\u043B\u044C\u043D\u043E):" }), _jsx("input", { type: "text", value: userId, onChange: (e) => setUserIdState(e.target.value), placeholder: "\u0412\u0432\u0435\u0434\u0438\u0442\u0435 user ID", style: { width: "100%", padding: "0.5rem" }, disabled: isInitialized })] }), _jsx("button", { onClick: handleInit, disabled: isInitialized, style: {
